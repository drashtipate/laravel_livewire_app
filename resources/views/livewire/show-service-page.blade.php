...
<main>
    <section class="page-header" style="background-image: url(./front/images/about/services_page.jpg);background-size: cover;background-repeat: no-repeat;background-attachment: scroll;background-position: bottom center;background-color: #2d2d2d;height: 520px;padding-top: 170px;padding-bottom: 100px;">
        <div class="container">
            <div class="row">
    ...
    <section class="section bg-cover" style="background-image:url(./front/images/bg-1.jpg); padding-bottom:80px;">
        <div class="container">
            <div class="row justify-content-center">
                ...
                <div class="icon-box-item text-center col-sm-6 col-lg-4 col-md-6 mb-4">
