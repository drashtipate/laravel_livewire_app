...
<main>
    <section class="banner overflow-hidden" >
        <div class="slide-inner" style="background-image: url(./front/images/slide-2.jpg);">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6 mb-5 mb-lg-0">
                        <div class="block  text-lg-start pe-0 pe-xl-5 ">
                            <h1 class="text-capitalize mb-4">We are ready to IT Solution Work.</h1>
                            <p class="mb-4" style="color:#fff;">Unlocking Potential, Igniting Excellence</p> 
                            <div class="">
                                <a type="button" class="button_link_1 me-3 " href="{{ route('servicesPage') }}">Learn More<span style="font-size: 14px;" class="ms-2 fas fa-arrow-right"></span></a>
                                <a type="button" class="button_link" href="{{ route('contact') }}" >Get in Touch<span style="font-size: 14px;" class="ms-2 fas fa-arrow-right"></span></a>
                            </div>
                        </div>
                    </div>
