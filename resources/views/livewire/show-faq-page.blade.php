<main>
    <section class="page-header" style="background-image: url(./front/images/faq_page_title_bg.jpg); background-size:cover; background-repeat:no-repeat; background-attachment:scroll; background-position:bottom center;background-color:#f2f2f4; height:520px; margin-bottom:40px; padding-top:170px; padding-bottom:100px;">
        <div class="container">
            <div class="row">
                <div class="col-8 mx-auto text-center">
                    <h2 class="mb-3 text-capitalize">FAQ`s</h2>
                        ...
                        @if ($faqs->isNotEmpty())
                            ...
                            <div class="accordion-item">
                                <div class="d-flex align-items-center text-uppercase">
                                    @if ($faq->image != '')
                                    <span class="faq-icon">
                                        <img  loading="lazy" decoding="async" src="{{ asset($faq->image) }}" alt="Post Thumbnail">
                                    </span>
                                    @endif
                                    <div class="accordion-header accordion-button h6 border-0"
