@section('title', 'about')
<main>
    <section class="page-header" style="background-image: url(../front/images/about/about_us_page_title_bg.jpg);background-size: cover;background-repeat: no-repeat;background-attachment: scroll;background-position: bottom center;background-color: #2d2d2d;height: 520px;padding-top: 170px;padding-bottom: 100px;">
        <div class="container">
            <div class="row">
            ...
            @if ($page->image != "")
                <div class="row justify-content-center align-items-center">
                    <div class="col-lg-4 mt-5 mt-lg-0">
                        <img loading="lazy" decoding="async" src="{{ asset($page->image) }}" alt="img" class="rounded w-100">
                    </div>
                    <div class="col-lg-6 offset-1">
                        <div class="section-title" style="">
                            {!! $page->content !!}
                        </div>
                        <a type="button" class="button_link_2 me-3" href="{{ route('contact') }}" style="bottom:4rem;">Get in Touch<span style="font-size: 14px;" class="ms-2 fas fa-arrow-right"></span></a>
                    </div>
