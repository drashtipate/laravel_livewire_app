@section('title', 'Team')
<main>
    <section class="page-header" style="background-image: url(./front/images/about/team_page_title_bg.jpg);background-size: cover;background-repeat: no-repeat;background-attachment: scroll;background-position: bottom center;background-color: #2d2d2d;height: 520px;padding-top: 170px;padding-bottom: 100px;">
        <div class="container">
            <div class="row">
    ...
    <section class="section teams bg-cover" style="background-image:url(./front/images/bg-1.jpg); padding-bottom:80px;">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12">
                    <div class="section-title text-center">
                        <p class="text-primary text-uppercase fw-bold mb-3">Team Members</p>
                        <h1>We are a Professional Creative Team</h1>
                        <p class="mb-0">Company's employs some of the best tech talent in Eastern Europe which is well<br> reflected in its smooth operations and relentless growth.</p>
                    </div>
                </div>
            </div>
            <div class="row position-relative justify-content-center">
                @if ($members->isNotEmpty())
                    ...
                    <div class=" col-lg-3 col-md-6 mt-4 team-card">
