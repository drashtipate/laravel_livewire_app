@section('title', 'Blog')
<main>
    <section class="page-header" style="background-image: url(./front/images/about/page_title_bg.jpg);background-size: cover;background-repeat: no-repeat;background-attachment: scroll;background-position: bottom center;background-color: #2d2d2d;height: 520px;margin-bottom: 40px;padding-top: 170px;padding-bottom: 100px;">
        <div class="container">
            <div class="row">
                            ...
                            <!-- if ($articles->isNotEmpty()) -->
                                ...
                                <div class="col-md-6" data-aos="fade">
                                    <article class="blog-post">
                                        ...
                                        <div class="pt-4">
                                            <p class="mb-3">{{ \Carbon\Carbon::parse($article->created_at)->format('M d, Y') }}</p>
                                            <div class="content-blog">
                                                <h2 class="h4"><a class="text-black" href="{{ route('blogDetail', $article->id)}}">{{ $article->title}}</a></h2>
                                                <a href="{{ route('blogDetail', $article->id)}}" class="btn-arrow text-primary fw-bold" aria-label="Read the full article by clicking here">Read More
                                                    <span>
                                                        <i class="fas fa-arrow-right ms-2 icon"></i>
                                                    </span>
                                                </a>
                                            </div>
                                        </div>
                ...
                <div class="col-lg-3">
                    ...
                    <div class="widget widget-categories">
                        ...
                        <ul class="list-unstyled widget-list">
                            @if ($categories->isNotEmpty())
                                ...
                                <li>
                                    <!-- <a href="{{ route('blog').'?categorySlug='.$category->slug }}">{{ $category->name }}</a> -->
                                        
                                        <a wire:click="setCategory('{{ $category->slug }}', '{{ $category->name }}')" href="javascript:void(0)">
                                            {{ $category->name }}
                                        </a>
                    ...
                    <div class="widget widget-tags">
                        ...
                        <ul class="list-inline widget-list widget-list-inline taxonomies-list">
                            <li class="list-inline-item"><a href="#!">Learing</a>
                            </li>
                            <li class="list-inline-item"><a href="#!">Course</a>
                            </li>
                            <li class="list-inline-item"><a href="#!">Business</a>
                            </li>
                            <li class="list-inline-item"><a href="#!">Udemy</a>
                            </li>
                            <li class="list-inline-item"><a href="#!">Online</a>
                            </li>
                            <li class="list-inline-item"><a href="#!">Technology</a>
                            </li>
                            ...
                            @foreach ($latestArticles as $latestArticle)
                                <ul class="list-unstyled widget-list">
                                    <li class="d-flex widget-post align-items-center">
                                        <a class="text-black" href="{{ route('blogDetail', $latestArticle->id)}}">
                                            <div class="widget-post-image flex-shrink-0 me-3">
                                                ...
                                                @if ($latestArticle->image != '')
                                                    <img class="rounded" loading="lazy" decoding="async" src="{{ asset($latestArticle->image) }}" alt="Post Thumbnail">
                                                @endif
                                            </div>
                                        </a>
